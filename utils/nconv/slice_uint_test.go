 ...
 * @LastEditTime: 2023-04-28 16:08:28
...
func TestToUint64SliceE(t *testing.T) {
	...
	errLog(t, err)
	if assert.NoError(err) {
		assert.Equal([]uint64{1, 2, 1, 0, 1}, actualObj)
	}
...
func TestToUint32SliceE(t *testing.T) {
	...
	errLog(t, err)
	if assert.NoError(err) {
		assert.Equal([]uint32{1, 2, 1, 0, 1}, actualObj)
	}
...
func TestToUint16SliceE(t *testing.T) {
	...
	errLog(t, err)
	if assert.NoError(err) {
		assert.Equal([]uint16{1, 2, 1, 0, 1}, actualObj)
	}
...
func TestToUint8SliceE(t *testing.T) {
	...
	errLog(t, err)
	if assert.NoError(err) {
		assert.Equal([]uint8{1, 2, 1, 0, 1}, actualObj)
	}
...
func TestToUintSliceE(t *testing.T) {
	...
	errLog(t, err)
	if assert.NoError(err) {
		assert.Equal([]uint{1, 2, 1, 0, 1}, actualObj)
	}
