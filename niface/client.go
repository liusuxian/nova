 ...
 * @LastEditTime: 2023-03-24 14:21:41
...
type IClient interface {
	...
	SetOverLoadMsg(*OverLoadMsgOption)                   // 设置当前 Client 的服务器人数超载消息
	SetHeartBeat(option *HeartBeatOption, initiate bool) // 设置当前 Client 的心跳检测
}
