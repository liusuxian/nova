 ...
 * @LastEditTime: 2023-03-08 21:47:12
...
type IRequest interface {
	...
	SetCtxVal(key string, value any)      // 将键值对作为自定义参数设置到请求的上下文信息中
	GetCtxVal(key string, def ...any) any // 检索并返回给定键名的值，可选参数 def 指定如果请求的上下文信息中不存在给定的 key 时的默认值
